...
Once Jenkins is installed, you need to go to your AWS EC2 Security Group and open Inbound Port 8080, since Jenkins works on Port 8080. (We already opened the relavant ports)
